...
public class Doctor 
{
	...
	public Doctor(String firstName, String lastName, String specialty, String userName, String password)
	{
		String injection = "INSERT INTO doctor (`firstName`, `lastName`, `specialty`, `userName`, `password`) VALUES ('"+firstName+"', '"+lastName+"', '"+specialty+"', '"+userName+"', '"+password+"');";
		Adapter.injection(injection);
	}
