...
public class PatientViewController implements Initializable
{
	...
	@FXML private Label heightLabel, weightLabel, bloodLabel, illnessLabel, emailLabel, phoneLabel, prescriptionNameLabel, appointmentLabel, attendanceLabel;
	...
	public void initialize(URL arg0, ResourceBundle arg1)
	{
		...
		try
		{
			...
			attendanceNum = patientResultSet.getInt("attendanceTrack");
		...
		if(attendanceNum<2){
		attendanceLabel.setText("You have missed " +attendanceNum+ " appointments. Keep up the good work!");
		}
		else if(attendanceNum>=2 && attendanceNum<=4){
		attendanceLabel.setText("You have missed " +attendanceNum+ " appointments.");
		}
		else if(attendanceNum>4){
		attendanceLabel.setText("You have missed " +attendanceNum+ " appointments. Your doctor has been notified.");
	}
		setDoctorTableView();
		setClinicTableView();
